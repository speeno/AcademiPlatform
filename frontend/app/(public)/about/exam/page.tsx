...
const steps = [
  ...
  {
    num: 6,
    title: '교재 북티켓 발행 또는 교재구매',
    desc: '수강 연계 교재는 마이페이지에서 북티켓을 확인·사용하고, 필요 시 온라인 교재 또는 별도 구매 페이지에서 교재를 준비합니다.',
  },
  { num: 7, title: '시험 응시', desc: '안내된 일시와 장소에서 시험을 응시합니다.' },
  { num: 8, title: '필기·실기 시험', desc: '필기시험 40문항, 60점 이상 합격 후 실기시험을 응시합니다.' },
  { num: 9, title: '합격증서 발급', desc: '합격 후 4주 이내 합격증서를 신청 주소로 배송합니다.' },
];
            ...
            <BrandCard padding="lg" className="border-yellow-200 bg-yellow-50">
              <div className="flex gap-3">
                ...
                <div className="text-sm text-yellow-800 space-y-2">
                  ...
                  <p>• 상황에 따라 시험장 입장 시 휴대폰 소지 금지가 될 수도 있습니다.</p>
                </div>
              </div>
            </BrandCard>
          </div>
