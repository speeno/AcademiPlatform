  ...
  return (
    <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 space-y-3 mb-6">
      <div className="flex items-center gap-2">
        <Landmark className="w-5 h-5 flex-shrink-0 text-brand-orange"  />
      ...
      <dl className="text-sm space-y-1.5">
        <div className="flex gap-2">
          <dt className="text-muted-foreground shrink-0 w-20">입금은행</dt>
          <dd className="font-medium text-foreground">{account.bank}</dd>
        </div>
        <div className="flex gap-2">
          <dt className="text-muted-foreground shrink-0 w-20">입금계좌</dt>
          <dd className="font-semibold text-foreground tracking-wide">{account.account}</dd>
        </div>
        <div className="flex gap-2">
          <dt className="text-muted-foreground shrink-0 w-20">예금주</dt>
          <dd className="font-medium text-foreground">{account.holder}</dd>
        </div>
      </dl>
      <p className="text-xs text-muted-foreground">
