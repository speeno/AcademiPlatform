  ...
  return (
    <div>
      ...
      <section className="bg-hero-gradient py-16 border-b">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">
            전문가와 함께하는<br />
            <span style={{ color: 'var(--brand-blue)' }}>라이브 세션 & 설명회</span>
          </h1>
          ...
          <div className="flex justify-center gap-8 mt-8 text-sm text-gray-500">
            <div className="text-center">
              <p className="text-2xl font-extrabold" style={{ color: 'var(--brand-blue)' }}>30+</p>
              <p className="mt-0.5">2026년 목표 세션</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-extrabold" style={{ color: 'var(--brand-orange)' }}>2,000+</p>
              <p className="mt-0.5">2026년 목표 참여자</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-extrabold" style={{ color: 'var(--brand-blue)' }}>100%</p>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-2 mb-8">
            <Calendar className="w-5 h-5" style={{ color: 'var(--brand-blue)' }} />
            <h2 className="text-xl font-extrabold text-gray-900">예정된 세션</h2>
          </div>
              ...
              return (
                <BrandCard key={session.id} className="p-6">
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    {/* 날짜 블록 */}
                    <div className="flex-shrink-0 text-center bg-gray-50 rounded-xl px-5 py-3 border min-w-[80px]">
      ...
      <section className="py-14 bg-gray-50 border-t">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-2 mb-8">
            <PlayCircle className="w-5 h-5" style={{ color: 'var(--brand-orange)' }} />
            <h2 className="text-xl font-extrabold text-gray-900">지난 세션 다시보기</h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {pastSessions.map((ps) => (
              <BrandCard key={ps.id} className="overflow-hidden p-0">
                ...
                <div className="p-4">
                  <h3 className="font-bold text-gray-900 text-sm mb-1">{ps.title}</h3>
                  <p className="text-xs text-gray-400 mb-3 line-clamp-2">{ps.description}</p>
      ...
      <section className="py-16 bg-white border-t">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow"
